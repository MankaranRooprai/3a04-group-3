...
\begin{thebibliography}{9}
    \bibitem{ref1} Non-functional requirements - the University of Texas at ..., https://personal.utdallas.edu/~chung/SYSM6309/NFR-18-4-on-1.pdf (accessed Feb. 7, 2025).
    \bibitem{ref2} AltexSoft,"Nonfunctional requirements:Examples, types and approaches,"AltexSoft,https://www.altexsoft.com/blog/non-functional-requirements/ (accessed Feb. 7, 2025).
    \bibitem{ref3} “Android mobile App Developer tools,” Android Developers, https://developer.android.com/ (accessed Feb. 7, 2025). 
	\bibitem{ref4} insert ref here
	\bibitem{ref4} insert ref here
\end{thebibliography}
