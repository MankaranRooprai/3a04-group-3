...
% Begin Section
\includegraphics[scale=0.46]{ident_mng_state_diag.png}
\centering{\textbf{Figure 2.1 Identification Manager State Diagram}}
% End Section
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{removelater.jpg} % replace image with diagram
